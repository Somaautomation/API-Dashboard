...
function useCount(target, durationMs = 600) {
...
export default function KpiCard({ label, value, suffix, icon: Icon, accent = "sky", help }) {
    ...
    const display = typeof value === "number"
        ...
        : value;
    return (_jsxs("div", { className: `card p-4 ring-1 ${a.ring} hover:shadow-md transition-shadow`, children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("div", { className: "text-xs font-medium text-slate-500 uppercase tracking-wide", children: label }), Icon && (_jsx("div", { className: `h-8 w-8 rounded-lg ${a.bg} ${a.text} grid place-items-center`, children: _jsx(Icon, { size: 16 }) }))] }), _jsxs("div", { className: "mt-2 text-2xl font-bold tabular-nums", children: [display, suffix && _jsx("span", { className: "text-base font-medium text-slate-500 ml-1", children: suffix })] }), help && _jsx("div", { className: "text-[11px] text-slate-500 mt-1", children: help })] }));
}
